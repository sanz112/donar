                                    ...
                                    <div id="submenu-5" class="collapse submenu">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                              ...
                                              <li class="nav-item">
                                                <a class="nav-link" href="iconsms/autobank.php">Automated Bank Transfer (N20 charge)</a>
                                            </li>
                                            <li class="nav-item">
...
<!-- Latest compiled and minified CSS -->
 ...
 <script>
        ...
        <div style="width: 100%;" class="card-body">
            ...
            <thead>
                <tr>
                    <th><h2> Edit Your Profile page </h2></th>
                ...
                <tbody>
                                    <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b>Your ID: 1 </td>

                    </tr>
                        <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your Username: </b>wittstack </td>
                </tr>
                <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your Email: </b>wittstack@gmail.com </td>
                </tr>
                    <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your Phone Number: </b>08132782405 </td>
                </tr>
                <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your Wallet Balance: </b><span>&#x20A6</span>1780.00 </td>
                </tr>
                       <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b>Confirmation: </b>True </td>
                </tr>
                  <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your User Type: </b>Admin </td>
                </tr>
                 <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your Bank: </b>Wema Bank </td>
                </tr>
                 <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your User Type: </b>0229852464 </td>
                </tr>
                        <tr>
                        <td>
                            <div style="float: left;" class="p-2 row">
                                     
                             <a class="btn pr-3 mr-2 col btn-md btn-warning" style="background-color: green;" id="updatenewuser"name="updatenewuser" href="update.php?id=1"> Edit </a>
                             <a class="btn btn-md col btn-danger" id="deletenewuser" name ="deletenewuser" onclick="return confirm('Are You Sure You Want to Delete Your Account')" style="background-color: red;" href="delete.php?id=1"> Delete </a>
