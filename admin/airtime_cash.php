            ...
            <thead>
                ...
                <?php foreach($results as $r): ?>
                    <tr>
                        ...
                        <td><?php echo $r->referenceId; ?> </td>
                        <td><?php echo $r->uidSwift; ?> </td>
                        <td><?php echo $r->firstName; ?> </td>
                        <td><?php echo $r->networkProvider; ?> </td>
                        <td><?php echo $r->lastName; ?> </td>
                        <td><?php echo $r->email; ?> </td>
                        <td><?php echo $r->amount; ?> </td>
                        <td><?php echo $r->amountReceived; ?> </td>
                        <td><?php echo $r->phone; ?> </td>
                        <td><?php echo $r->datet; ?> </td>
                        
                        <td>
                            <!-- <div class="p-2 row">
                                     
                             <a class=" btn mb-2 btn-md btn-warning" href="update.php?id=<?= $r->idSwiftUsers ?>"> Edit  </a>
                             <a class="btn btn-md btn-danger" onclick="return confirm('Are You Sure You Want to Delete this User')" href="delete.php?id=<?= $r->idSwiftUsers ?>"> Delete </a>
