...
<div class="mt-2 py-3 text-muted">
    <p  class=" text-center">
        ...
        . | <a style="color: #fff;" href="../swiftdetails/swiftDeveloper_api.php">Developers' API</a> | Designed and Powered by <a style="cursor: pointer;" href="https://wa.me/message/LCCPGHQCMQKYK1"><span style="color: #fff;">Witt</span><span style="color:plum;">Stack</span></a>
        . All Rights Reserved
      </p>
</div>
</div>
